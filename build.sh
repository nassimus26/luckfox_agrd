...
#done
echo 'synchronizing with pico ...'
####   sshpass -pluckfox scp -r ~/ai/* root@192.168.1.31:/root/ai/
sshpass -pluckfox scp ${ROOT_PWD}/install/luckfox_pico_yolov5_demo/luckfox_pico_yolov5 root@192.168.1.31:/root/ai/app
#sshpass -pluckfox scp ${ROOT_PWD}/install/luckfox_pico_yolov5_demo/luckfox_pico_yolov5 root@172.32.1.93:/root/ai/app
echo Done !
